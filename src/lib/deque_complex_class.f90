!/ ====================================================================== BEGIN FILE =====
!/ **                       D E Q U E _ C O M P L E X _ C L A S S                       **
!/ =======================================================================================
!/ **                                                                                   **
...
contains !/**                   P R O C E D U R E   S E C T I O N                       **
  ...
  subroutine zdeque_destroy( iqueue )
    ...
    !/ -----------------------------------------------------------------------------------
    implicit none
    type(DequeComplex) :: iqueue !! new deque structure.
    !/ -----------------------------------------------------------------------------------
  ...
  pure function zdeque_is_empty( self ) result( stat )
    ...
    !/ -------------------------------------------------------------------------------------
    implicit none
    class(DequeComplex), intent(in) :: self !! reference to this deque.
  ...
  subroutine zdeque_clear( self, del )
    ...
    !/ -------------------------------------------------------------------------------------
    implicit none
    class(DequeComplex), intent(inout) :: self !! reference to this deque.
  ...
  subroutine zdeque_push_head( self, n )
    ...
    !/ -----------------------------------------------------------------------------------
    implicit none
    class(DequeComplex), intent(inout) :: self !! reference to this deque class.
  ...
  function zdeque_peek_head( self, stat, errmsg ) result( val )
    ...
    !/ -----------------------------------------------------------------------------------
    implicit none
    class(DequeComplex),    intent(in)  :: self   !! reference to this deque class.
    integer,      optional, intent(out) :: stat   !! optional error status.
    character(*), optional, intent(out) :: errmsg !! optional error message.
    complex(dp)                         :: val    !! returned data.
    !/ -----------------------------------------------------------------------------------
...
end module deque_complex_class
